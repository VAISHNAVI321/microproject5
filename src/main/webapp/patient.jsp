...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" name="vital" id="vital" style="display:inline-block; width:300px;margin-top:25px;"><br><br>
		<label>Enter Phone Number :</label>
		<input class="form-control form-control-sm" type="text" name="phno" id="phno" style="display:inline-block; width:300px;margin-top:25px;"><br><br>
	...
	<script>
		var websocket=new WebSocket("ws://localhost:8082/websocket/VitalCheckEndPoint");
